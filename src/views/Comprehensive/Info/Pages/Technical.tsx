        ...
        const parts = [
            {
                ...
                value:
                    "Der MIO Viewer stellt medizinische Informationsobjekte für Patient:innen, Ärzt:innen und weitere interessierte Personen dar. Da die FHIR®-Dateien für Menschen schwer lesbar sind, soll mit dem Viewer Abhilfe geschafft und die Inhalte klar und einfach dargestellt werden."
            },
            {
                label: "Wer hat den MIO Viewer entwickelt?",
                value:
                    "Verantwortlich für die Entwicklung des MIO Viewers ist die Kassenärztliche Bundesvereinigung (KBV)."
            },
            {
                label: "Sind meine Daten hier sicher?",
                value:
                    "Die Anwendung speichert keinerlei Daten von Ihnen. Alles was die Anwendung braucht, um das MIO darzustellen ist bereits auf dem Gerät installiert. Es wird keine Internetverbindung benötigt und es wird keine Auswertung der Daten vorgenommen. Damit der Viewer funktioniert, müssen die MIO-Dateien jedoch vorher aus der elektronischen Patientenakte (ePA) auf das Gerät geladen werden, um sie dann im Viewer zu öffnen."
            },
            {
            ...
            },
            {
                ...
                value:
                    "Derzeit ist diese Funktion nicht in Planung. Die Anwendung akzeptiert lediglich unverschlüsselte Dateien. Daher müssen Sie ihre MIOs im Vorfeld aus der ePA laden um sie dann in dieser Anwendung zu öffnen."
            },
            {
                label: "Welche MIOs sind unterstützt?",
                value:
                    "Unser Ziel ist es zu jeder offiziellen Veröffentlichung eines MIOs den Viewer ebenfalls zu aktualisieren, um die MIOs darstellen zu können."
            },
            {
                label: "Wo finde ich weitere Informationen?",
                value:
                    "Auf <a href='https://mio.kbv.de' target='_blank' rel='noopener noreferrer'>mio.kbv.de</a> gibt es alle Informationen zu den MIOs und deren Definitionen."
            }
        ];
        return (
            <UI.BasicView
