...
export default class Compare {
    public static StampInformation(
        a: MIOEntry<MR.V1_1_0.Profile.Organization | MR.V1_1_0.Profile.Practitioner>,
        b: MIOEntry<MR.V1_1_0.Profile.Organization | MR.V1_1_0.Profile.Practitioner>
    ): number {
        if (
            MR.V1_1_0.Profile.Practitioner.is(a.resource) &&
            MR.V1_1_0.Profile.Organization.is(b.resource)
        ) {
            return -1;
        } else if (
            MR.V1_1_0.Profile.Practitioner.is(b.resource) &&
            MR.V1_1_0.Profile.Organization.is(a.resource)
        ) {
            return 1;
        } else if (
            MR.V1_1_0.Profile.Organization.is(a.resource) &&
    ...
    public static Appointment(
        ...
        if (
            MR.V1_1_0.Profile.AppointmentPregnancy.is(a.resource) &&
            MR.V1_1_0.Profile.AppointmentPregnancy.is(b.resource)
        ) {
    ...
    public static DateDetermination(
        ...
        if (MR.V1_1_0.Profile.ObservationDateDeterminationChildbirth.is(a.resource)) {
            return 1;
        } else if (
            MR.V1_1_0.Profile.ObservationDateDeterminationChildbirth.is(b.resource)
        ) {
            return -1;
        } else if (timeA && timeB) {
