...
const interpretationConceptMaps: ParserUtil.ConceptMap[] = [
    CMR.V1_0_0.ConceptMap.CMRU1U3PulseOxymetryMeasurementGerman
];
...
export default class ObservationModel extends BaseModel<ObservationType> {
    constructor(
        ...
        if (
            !CMR.V1_0_0.Profile.CMRObservationU1U5CounselingAboutHearscreening.is(value)
        ) {
            this.values.push({
    ...
    protected getObservationValue(): ModelValue {
        ...
        if (
            CMR.V1_0_0.Profile.CMRObservationU1U5CounselingAboutHearscreening.is(resource)
        ) {
    ...
    protected getComponent(): ModelValue | undefined {
        ...
        if (resource.component) {
            ...
            if (CMR.V1_0_0.Profile.CMRObservationU3U4HipScreeningResult.is(this.value)) {
                values.sort((a, b) =>
                    a.label > b.label ? 1 : b.label > a.label ? -1 : 0
                );
            }

            const isLengthGestationAtBirth = CMR.V1_0_0.Profile.CMRObservationU1U3LengthGestationAtBirth.is(
                this.value
            );
    ...
    public getBodySite(): ModelValue | undefined {
        if (
            CMR.V1_0_0.Profile.CMRObservationU3U4HipScreeningResult.is(this.value) &&
            this.value.bodySite
        ) {
            const value = Util.FHIR.getCoding({ code: this.value.bodySite }, [
                CMR.V1_0_0.ConceptMap.CMRBodysiteHipGerman
            ]);
    ...
    public getDerivedFrom(): ModelValue[] {
        ...
        if (CMR.V1_0_0.Profile.CMRObservationPercentileValues.is(this.value)) {
    ...
    public getMainValue(): ModelValue {
        ...
        if (CMR.V1_0_0.Profile.CMRObservationU1U3PregnancyHistory.is(this.value)) {
            value = this.getCoding();
            label = Util.Misc.formatDate(this.value.effectiveDateTime);
        } else if (
            CMR.V1_0_0.Profile.CMRObservationU1U3Birthmode.is(this.value) ||
            CMR.V1_0_0.Profile.CMRObservationU1U3FoetalPosition.is(this.value)
        ) {
            value = this.getCoding();
        }
        ...
        return {
            ...
            renderAs: CMR.V1_0_0.Profile.CMRObservationU1FamilyHistory.is(this.value)
                ? UI.ListItem.NoLabel
                : undefined
        };
    }
    ...
    public toPDFContent(
        ...
        if (CMR.V1_0_0.Profile.CMRObservationU1U3Birthmode.is(this.value)) {
            heading = "Geburtsmodus - " + heading;
        } else if (
            CMR.V1_0_0.Profile.CMRObservationU1U3FoetalPosition.is(this.value) ||
            CMR.V1_0_0.Profile.CMRObservationU1U3DifferentFoetalPosition.is(this.value)
        ) {
