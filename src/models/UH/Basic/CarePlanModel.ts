...
export type CarePlanType =
    | CMR.V1_0_1.Profile.CMRCarePlanU2U9Result
    | CMR.V1_0_1.Profile.CMRCarePlanU3U4HipScreeningPlan;
...
export default class CarePlanModel extends BaseModel<CarePlanType> {
    constructor(
        ...
        if (CMR.V1_0_1.Profile.CMRCarePlanU3U4HipScreeningPlan.is(this.value)) {
            ...
            if (CMR.V1_0_1.Profile.CMRCarePlanU3U4HipScreeningPlan.is(this.value)) {
                values.push({
                    value: Util.FHIR.handleCode(detail.code, [
                        CMR.V1_0_1.ConceptMap.CMRHipProceedingGerman
                    ]).join(", "),
                    label: ""
                });
            } else {
