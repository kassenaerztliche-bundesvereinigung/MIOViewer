...
export type ServiceRequestType =
    | CMR.V1_00_000.Profile.CMRServiceRequestU1U5ReferralPediatricAudiologyService
    | CMR.V1_00_000.Profile.CMRServiceRequestU1U3PulseOxymetryClarification
    | CMR.V1_00_000.Profile.CMRServiceRequestDentalReferral;
...
export default class ServiceRequestModel extends BaseModel<ServiceRequestType> {
    ...
    protected getReasonReference(): ModelValue | undefined {
        if (
            CMR.V1_00_000.Profile.CMRServiceRequestU1U3PulseOxymetryClarification.is(
                this.value
            )
        ) {
            ...
            if (refs.length) {
                const ref = refs[0];
                const result = ParserUtil.getEntryWithRef<CMR.V1_00_000.Profile.CMRObservationU1U3PulseOxymetryMeasurement>(
                    this.parent,
