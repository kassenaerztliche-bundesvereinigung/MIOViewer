...
export type MedicationPlanType = CMR.V1_00_000.Profile.CMRMedicationStatementVitamineKProphylaxis;
        ...
        this.values.push(
            ...
            Util.UH.getEncounterModelValue(encounterRef, parent, history),
            {
                value: ParserUtil.translateCode(
                    this.value.status,
                    CMR.V1_00_000.ConceptMap.CMRMedicationStatementStatusGerman
                ).join(", "),
                label: "Status"
            },
            {
